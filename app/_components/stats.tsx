...
const Stats = ()=>{
  ...
  <div className="flex flex-col items-center bg-white rounded-2xl shadow-lg p-8 w-72 hover:scale-105 transition-transform duration-300">
    ...
    <h3 className="text-xl font-semibold text-gray-700 mb-2">Jobs Posted</h3>
  ...
  <div className="flex flex-col items-center bg-white rounded-2xl shadow-lg p-8 w-72 hover:scale-105 transition-transform duration-300">
    ...
    <h3 className="text-xl font-semibold text-gray-700 mb-2">Active Job Seekers</h3>
  ...
  <div className="flex flex-col items-center bg-white rounded-2xl shadow-lg p-8 w-72 hover:scale-105 transition-transform duration-300">
    ...
    <h3 className="text-xl font-semibold text-gray-700 mb-2">Companies Hiring</h3>
