    ...
    <div className="w-full flex flex-col md:flex-row overflow-auto">
      <div className="px-10 pt-24  wrap-break-word flex flex-1 flex-col gap-5">
        <h1 className="font-bold text-5xl text-[#0a2540] leading-tight">
          Step Into Your Future with the Perfect Job
        </h1>
        <p>
          Browse thousands of openings, apply in seconds, and land the role you
          deserve.
        </p>
        <a className="w-fit px-4 py-2 rounded-full bg-sky-600 text-white font-bold cursor-pointer hover:bg-[#0a2540]">
          Find Jobs&nbsp;
